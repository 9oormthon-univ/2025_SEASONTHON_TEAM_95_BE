...
public class AiDetectionService {
    ...
    AnalysisResponse detect(AIDetectionRequest request) {
        ...
        log.info("AI 서버 응답 수신: {}", aiResponse.toString());
    ...
    private AnalysisResponse convertToAnalysisResponse(AIDetectionResponse aiResponse) {
        return AnalysisResponse.builder()
                ...
                .conclusion(aiResponse.results().conclusion())      // results에서 가져오도록 변경
                .evidences(aiResponse.results().evidence())         // results에서 가져오도록 변경
                .build();
    }
